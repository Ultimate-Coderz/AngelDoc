    ...
    <div class="container">
        <div class="row justify-content-md-center">
            <div class="col-md-6 py-5 section-title">
                <h2 class="text-center ">Add Coordinator</h2>

 


                <form id="coordinator" class="formSelect text-center "
                    action="AddCoordinatorServ" method="post">
                    <div class="row g-2">
                        <div class="col-md">
                    ...
                    <div class="col-md">
                        <div class="form-floating mb-3">
                            <input type="password" class="form-control" id="floatingInput" required pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters"
                    ...
                    <div class="col-md">
                        <div class="form-floating mb-3">
                            <input type="number" class="form-control" id="floatingInput" required
                                placeholder="Contact No." name="contactNum"> <label
                    ...
                    <div class="col-md">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="floatingInput" required
                                placeholder="Designation" value="Coordinator" readonly name="designation"> <label
                                for="floatingInput">Designation</label>
                        </div>
                    </div>

                    <br> <input type="hidden" name="role" value=2> <input

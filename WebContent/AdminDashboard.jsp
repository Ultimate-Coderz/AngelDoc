	...
	<header id="header">
		<div class="d-flex flex-column">
			...
			<div class="profile">
				...
				<h1 class="text-light"
					style="font-size: smaller; color: rgb(152, 175, 219) !important;">Admin</h1>
			</div>
			...
			<nav id="navbar" class="nav-menu navbar ">
				<ul>
					...
					<li><a href="UpdateCoordinatorDash.jsp" class="nav-link "><i
		...
		<div class="text-center m4">
			<div class="text-center text-dark mt-6">
				<br> <br>
				<br>
				<br>
				<small><i class="far fa-copyright"></i> Copyright AngelDoc.com</small>
			</div>
		</div>
	</header>
	<%
	AdminDashboardDAO adao = new AdminDashboardDAO();
	long docCount = adao.getDoctorCount();
	long patCount = adao.getPatientCount();
	long cordCount = adao.getCoordinatorCount();
	%>
	<div id="main">
					...
					<div class="col-md-4">
						<div class="count-box">
							<i class="fas fa-user-md"></i> <span data-purecounter-start="0"
								data-purecounter-end=<%=docCount%> data-purecounter-duration="1"
					...
					<div class="col-md-4 mt-5 mt-md-0">
						<div class="count-box">
							<i class="fas fa-user-injured"></i> <span
								data-purecounter-start="0" data-purecounter-end=<%=patCount%>
					...
					<div class="col-md-4 mt-5 mt-md-0">
						<div class="count-box">
							<i class="fas fa-user"></i> <span data-purecounter-start="0"
								data-purecounter-end=<%=cordCount - 1%>
								data-purecounter-duration="1" class="purecounter"></span>
							<p>Coordinators</p>
						</div>
					</div>
		...
		<%
		List<Appointment> appList = adao.getAppointments();
		%>
		...
		<%
		List<Doctor> docList = adao.getDoctors();
		%>
				...
				<div class="row justify-content-md-center">
					<div class="section-dash doctor col-md-12 p-4">
						<div class="row">
							...
							<div class="col-4">
								<a href="AddDoctor.jsp" class="btn btn-primary float-end ">Add
									Doctor</a>
							</div>
						</div>
						<%
								...
								<tr>
									...
									<td class="text-center text-light"><a onclick="
										  Notiflix.Confirm.Show( 
												    ...
												    'Yes', 'No', 
												    function(){ 
												      window.location.href = 'DeleteUserServ?id=<%=a.getDocId()%>'; },
												    function(){  
		...
		<%
		List<Patient> patList = adao.getPatients();
		%>
				...
				<div class="row justify-content-md-center">
					<div class="section-dash patient col-md-12  p-4">
						...
						<div class="row">
							...
							<div class="col-4">
								<a href="AddPatient.jsp" class="btn btn-primary float-end ">Add
									Patient</a>
							</div>
						</div>
						<%
								...
								<tr>
									...
									<td class="text-center text-light"><a onclick="
										  Notiflix.Confirm.Show( 
												    ...
												    'Yes', 'No', 
												    function(){ 
												      window.location.href = 'DeleteUserServ?id=<%=a.getpId()%>'; },
												    function(){  
		...
		<%
		List<Coordinator> cordList = adao.getCoordinators();
		%>
		<section id="doctor" class="doctors">
			<div class="container">
				<div class="row justify-content-md-center">
					<div class="section-dash doctor col-md-12 p-4">
						<div class="row">
							<div class="col-4"></div>
							<div class="col-4">
								<h1 class="text-light text-center pb-3">Coordinators</h1>
							</div>
							<div class="col-4">
								<a href="AddCoordinator.jsp" class="btn btn-primary float-end ">Add
									Coordinator</a>
							</div>
						</div>
						<%
						...
						%>
						<hr style="color: black;" class="text-center">
						<h4 class="text-center text-light">No Coordinators</h4>
						<%
						} else {
						%>
						<table class="table table-responsive table-sm table-hover">
							...
							<%
							for (Coordinator a : cordList) {
							%>
							<tbody>
								<tr>
									<th class="text-center" scope="row"><%=a.getId() - 1%></th>
									<td class="text-center text-light"><%=a.getFirstName() + " " + a.getLastName()%></td>
									<td class="text-center text-light"><%=a.getDesignation()%></td>
									<td class="text-center text-light"><%=a.getContactNumber()%></td>
									<td class="text-center text-light"><a
                                        href="UserDetails.jsp?userId=<%=a.getId() %>"><i
                                            class='bx bx-info-circle mt-1'></i></a></td>
									<td class="text-center text-light"><a onclick="
										  Notiflix.Confirm.Show( 
												    'Confirm Delete', 
												    'Do you want to delete this coordinator?', 
												    'Yes', 'No', 
												    function(){ 
												      window.location.href = 'DeleteUserServ?id=<%=a.getId()%>'; },
												    function(){  
